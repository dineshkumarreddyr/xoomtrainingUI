...
(function(){
	...
	angular.module('xoomwebapp').controller('UserAccountController',useraccountController);

	function useraccountController($scope, $http, $xtAppConfig, $xtAppVariables, $stateParams, $state, $filter, $log,$managecookies) {
